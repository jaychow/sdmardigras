		...
		<div class="container">
			<nav class="navbar navbar-default" role="navigation">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="<?php echo SITE_URL; ?>"><img src="<?php echo MthemeCore::getOption("site_logo",""); ?>" alt=""/></a>
					<?php } ?>
			   </div>
...
<?php }elseif($logo_position=='header' || $logo_position=='both'){ ?>
	...
	<div class="header header-hide">
		<div class="container">
			<nav class="navbar navbar-default" role="navigation">
				<div class="navbar-header">				
					<a class="navbar-brand" href="<?php echo SITE_URL; ?>"><img src="<?php echo MthemeCore::getOption("site_logo",CHILD_URI."site/img/logo.png"); ?>" alt=""/></a>				
			   </div>
			</nav>
		</div>
	</div>
