	...
	if($slider_heading_option=='true' || $slider_icon_option=='true' || $slider_content_option=='true' || $coming_soon=='true' || $first_button_option=='true' || $notify_form_option=='true') { 
		...
		$contentOut.='<div class="container align-center ticket-options">';
			$contentOut.='<div class="row">';
				$contentOut.='<div class="col-xs-6 col-sm-5 ticket-option">';
					...
					$contentOut.='<div class="text-center">';
						$contentOut.='<img style="max-height:200px; class="img-responsive" src="'.CHILD_URI.'img/mardi-gras-2017.jpg" alt="San Diego Mardi Gras Block Party, Parade & Celebration Presented by Tickled Pink Production"/>';
					$contentOut.='</div>';
			...
			$contentOut.='<div class="col-xs-6 col-sm-5 col-sm-offset-2 ticket-option">';
				...
				$contentOut.='</div>';
				$contentOut.='<div class="text-center">';
					$contentOut.='<img style="max-height:200px;" class="img-responsive" src="'.CHILD_URI.'img/fat-tuesday-2017.jpg" alt="10th Annual San Diego Fat Tuesday Party Gras Presented by Club VIP and Gaslamp’s Top Nightclubs, Restaurants & Bars"/>';
				$contentOut.='</div>';
				$contentOut.='<div class="event_time">';
