			...
			$contentOut.='<div class="row">';
				$contentOut.='<div class="col-xs-6 col-sm-5 ticket-option">';
					$contentOut.='<div class="social-icons">';
						$contentOut .= '<a href="https://www.facebook.com/events/1254009684713957/" target="_blank"><i class="fa fa-calendar fa-2x"></i></a> <a href="http://www.facebook.com/ClubVIPSD" target="_blank"><i class="fa fa-facebook-official fa-2x"></i></a>';
					$contentOut.='</div>';
